...
5. **Haider** lands on **`/dispatch/inventory`** and maintains packaging stock (empty bottles, caps, stickers/labels, cartons/boxes, pouches, partitions). Product catalog `bottlesPerCarton` controls carton use, e.g. Rhino 250ml has 20 bottles/carton.
