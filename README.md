...
5. **Waleed Intisar** signs in at `/admin` for the **pending orders** grid, and can browse **Orders** (who entered each PO), **Production batches** (what Nimra registered), **Dispatch trips**, **Packaging inventory**, and **Daily filling &amp; waste** — all read-only.
