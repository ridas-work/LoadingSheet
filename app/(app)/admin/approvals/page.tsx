...
export default async function AdminApprovalsPage() {
  ...
  const rows = dedupedOrders.map((o) => {
    ...
    return {
      ...
      city: o.city?.trim() ?? "",
      deadlineDisplay: formatDeadline(o.deadlineDate),
      createdByName: o.createdByName?.trim() ?? "",
      createdAt: o.createdAt ? new Date(o.createdAt).toISOString() : "",
      cartonCount: (o.sheetLines ?? []).length,
      orderKind,
      requestTypeLabel: orderRequestTypeLabel(orderKind),
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <h2 className="text-lg font-semibold text-zinc-900">PO sample orders</h2>
