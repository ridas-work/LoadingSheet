...
export default async function BatchFillingPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Daily filling log"
        backHref="/dispatch/trips"
        backLabel="Dispatch trips"
        description={
          <>
            {readOnly
            ...
            <span className="mt-2 block text-xs text-slate-500">
              ...
              dispatch. <strong>Waste (L)</strong> compares QC remaining against derived liters from bottle counts
              plus physical liquid remaining.
            </span>
          </>
        }
        actions={
          <div className={`${ui.cardPadded} flex items-center gap-2 py-2 text-sm text-slate-600`}>
